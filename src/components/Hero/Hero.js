    ...
    <Wrapper>
      <picture>
          ...
          <source 
            ...
            `}
          />
          <HeroImage alt="Animal of the day - today: a cat staring at you" src="/images/hero-img.jpg" srcSet="/images/hero-img.jpg 1x, /images/hero-img@2x.jpg 2x, /images/hero-img@3x.jpg 3x" />
        </picture>
